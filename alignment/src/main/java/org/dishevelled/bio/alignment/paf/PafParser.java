...
public final class PafParser {
    ...
    private static final class PafLineProcessor implements LineProcessor<Object> {
        ...
        /** PAF parse listener. */
        private final PafParseListener listener;


        /**
         * Create a new PAF line processor.
         *
         * @param listener PAF parse listener
         */
        private PafLineProcessor(final PafParseListener listener) {
