...
public final class SplitBed extends AbstractSplit {
     ...
     * @param suffix output file suffix, must not be null
     */
    public SplitBed(final Path inputPath, final Long bytes, final Long records, final String prefix, final int leftPad, final String suffix) {
    ...
    public static void main(final String[] args) {
        ...
        PathArgument inputPath = new PathArgument("i", "input-path", "input BED path, default stdin", false);
        ...
        try
        {
            ...
            splitBed = new SplitBed(inputPath.getValue(), b, records.getValue(), p, leftPad.getValue(-1), s);
        }
