...
public final class FastaToParquet6 implements Callable<Integer> {
    ...
    private static final String CREATE_TABLE_SQL = "CREATE TABLE sequences (name VARCHAR, sequence VARCHAR, length LONG, alphabet VARCHAR)";
    ...
    private static final String USAGE = "dsh-fasta-to-parquet6 [args]";
     ...
     */
    public FastaToParquet6(final Path fastaPath, final File parquetFile, final String alphabet, final int rowGroupSize) {
    ...
    public static void main(final String[] args) {
        ...
        FastaToParquet6 fastaToParquet6 = null;
        try
        {
            ...
            fastaToParquet6 = new FastaToParquet6(fastaPath.getValue(), parquetFile.getValue(), alphabet.getValue(DEFAULT_ALPHABET), rowGroupSize.getValue(DEFAULT_ROW_GROUP_SIZE));
        }
        ...
        try {
            System.exit(fastaToParquet6.call());
        }
        catch (Exception e) {
            e.printStackTrace();
            System.exit(1);
