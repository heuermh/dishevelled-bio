...
public final class FilterPaf extends AbstractFilter {
    ...
    public static void main(final String[] args) {
        ...
        StringArgument rangeFilter = new StringArgument("r", "range", "filter by range, specify as queryName:start-end in 0-based coordindates", false);
        ...
        ArgumentList arguments = new ArgumentList(about, help, rangeFilter, mappingQualityFilter, scriptFilter, inputPafFile, outputPafFile);
