 ...
 * scaffolds in tab-separated values (tsv) text format.
 *
 * @since 3.0
 * @author  Michael Heuer
 */
public final class FastaToPangenome implements Callable<Integer> {
    private final Path fastaPath;
    private final File pangenomeFile;
    private final boolean sort;
    private static final String USAGE = "dsh-fasta-to-pangenome [args]";
     ...
     */
    public FastaToPangenome(final Path fastaPath, final File pangenomeFile, final boolean sort) {
    ...
    public static void main(final String[] args) {
        ...
        FastaToPangenome fastaToPangenome = null;
        try
        {
            ...
            fastaToPangenome = new FastaToPangenome(fastaPath.getValue(), pangenomeFile.getValue(), sort.wasFound());
        }
        ...
        try {
            System.exit(fastaToPangenome.call());
        }
        catch (Exception e) {
            e.printStackTrace();
            System.exit(1);
