...
public final class FastaToParquet5 implements Callable<Integer> {
    ...
    private static final String USAGE = "dsh-fasta-to-parquet5 [args]";
     ...
     */
    public FastaToParquet5(final Path fastaPath, final File parquetFile, final String alphabet, final int rowGroupSize) {
    ...
    public static void main(final String[] args) {
        ...
        FastaToParquet5 fastaToParquet5 = null;
        try
        {
            ...
            fastaToParquet5 = new FastaToParquet5(fastaPath.getValue(), parquetFile.getValue(), alphabet.getValue(DEFAULT_ALPHABET), rowGroupSize.getValue(DEFAULT_ROW_GROUP_SIZE));
        }
        ...
        try {
            System.exit(fastaToParquet5.call());
        }
        catch (Exception e) {
            e.printStackTrace();
            System.exit(1);
