...
public final class SplitSam extends AbstractSplit {
    ...
    public static void main(final String[] args) {
        ...
        FileArgument inputFile = new FileArgument("i", "input-file", "input SAM file, default stdin", false);
        ...
        try
        {
            ...
            splitSam = new SplitSam(inputFile.getValue(), b, records.getValue(), p, leftPad.getValue(-1), s);
        }
