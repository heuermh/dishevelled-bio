 ...
 */
public final class SplitFastq extends AbstractSplit {
    private final FastqReader fastqReader = new SangerFastqReader();
    private final FastqWriter fastqWriter = new SangerFastqWriter();
    private static final String USAGE = "dsh-split-fastq -r 100 -i foo.fq.gz";
     ...
     * @param suffix output file suffix, must not be null
     */
    public SplitFastq(final Path inputPath, final Long bytes, final Long records, final String prefix, final int leftPad, final String suffix) {
    ...
    public static void main(final String[] args) {
        ...
        PathArgument inputPath = new PathArgument("i", "input-path", "input FASTQ path, default stdin", false);
        ...
        StringArgument suffix = new StringArgument("s", "suffix", "output file suffix, e.g. .fq.gz", false);
        ...
        try
        {
            ...
            splitFastq = new SplitFastq(inputPath.getValue(), b, records.getValue(), p, leftPad.getValue(-1), s);
        }
