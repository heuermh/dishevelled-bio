...
public final class SplitFastq extends AbstractSplit {
    ...
    public static void main(final String[] args) {
        ...
        FileArgument inputFile = new FileArgument("i", "input-file", "input FASTQ file, default stdin", false);
        ...
        try
        {
            ...
            splitFastq = new SplitFastq(inputFile.getValue(), b, records.getValue(), p, leftPad.getValue(-1), s);
        }
