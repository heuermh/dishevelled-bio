...
public final class Tools implements Callable<Integer> {
    ...
    static SortedMap<String, Command> COMMANDS = new ImmutableSortedMap.Builder<String, Command>(Ordering.natural())
        ...
        .put("split-bed", new Command("split-bed", "split BED files", SplitBed.class))
        .put("split-fastq", new Command("split-fastq", "split FASTQ files", SplitFastq.class))
        .put("split-gff3", new Command("split-gff3", "split GFF3 files", SplitGff3.class))
        .put("split-interleaved-fastq", new Command("split-interleaved-fastq", "split interleaved FASTQ files", SplitInterleavedFastq.class))
        .put("split-vcf", new Command("split-vcf", "split VCF files", SplitVcf.class))
