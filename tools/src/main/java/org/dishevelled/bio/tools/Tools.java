...
public final class Tools implements Callable<Integer> {
    ...
    static SortedMap<String, Command> COMMANDS = new ImmutableSortedMap.Builder<String, Command>(Ordering.natural())
        ...
        .put("extract-fasta-kmers-to-parquet", new Command("extract-fasta-kmers-to-parquet", "extract kmers from DNA or protein sequences in FASTA format to Parquet format", ExtractFastaKmersToParquet.class))
        .put("extract-fasta-kmers-to-partitioned-parquet", new Command("extract-fasta-kmers-to-partitioned-parquet", "extract kmers from DNA or protein sequences in FASTA format to partitioned Parquet format", ExtractFastaKmersToPartitionedParquet.class))
        ...
        .put("fasta-to-parquet", new Command("fasta-to-parquet", "convert DNA or protein sequences in FASTA format to Parquet format", FastaToParquet.class))
        .put("fasta-to-partitioned-parquet", new Command("fasta-to-partitioned-parquet", "convert DNA or protein sequences in FASTA format to partitioned Parquet format", FastaToPartitionedParquet.class))
        ...
        .put("parquet-sequences-to-fasta", new Command("parquet-sequences-to-fasta", "convert sequences in Parquet format to FASTA format", ParquetSequencesToFasta.class))
