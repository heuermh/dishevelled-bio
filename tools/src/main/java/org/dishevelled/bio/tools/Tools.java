...
public final class Tools implements Callable<Integer> {
    ...
    static SortedMap<String, Command> COMMANDS = new ImmutableSortedMap.Builder<String, Command>(Ordering.natural())
        ...
        .put("compress-gfa1", new Command("compress-gfa1", "compress features in GFA 1.0 format to splittable bgzf or bzip2 compression codecs", CompressGfa1.class))
        .put("compress-gfa2", new Command("compress-gfa2", "compress features in GFA 2.0 format to splittable bgzf or bzip2 compression codecs", CompressGfa2.class))
        ...
        .put("filter-gfa1", new Command("filter-gfa1", "filter features in GFA 1.0 format", FilterGfa1.class))
        .put("filter-gfa2", new Command("filter-gfa2", "filter features in GFA 2.0 format", FilterGfa2.class))
