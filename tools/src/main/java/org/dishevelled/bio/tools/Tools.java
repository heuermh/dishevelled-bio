...
public final class Tools implements Callable<Integer> {
    ...
    static SortedMap<String, Command> COMMANDS = new ImmutableSortedMap.Builder<String, Command>(Ordering.natural())
        ...
        .put("fastq-to-parquet6", new Command("fastq-to-parquet6", "(beta) convert DNA sequences in FASTQ format to Parquet format, per thread output, no view", FastqToParquet6.class))
