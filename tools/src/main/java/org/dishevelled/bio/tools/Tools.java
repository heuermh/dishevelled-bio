...
public final class Tools implements Callable<Integer> {
    ...
    static SortedMap<String, Command> COMMANDS = new ImmutableSortedMap.Builder<String, Command>(Ordering.natural())
        ...
        .put("decode-segments", new Command("decode-segments", "decode segment sequences in GFA 1.0 format", DecodeSegments.class))
        ...
        .put("encode-segments", new Command("encode-segments", "encode segment sequences in GFA 1.0 format", EncodeSegments.class))
