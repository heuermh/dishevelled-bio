...
public final class Tools implements Callable<Integer> {
    ...
    static SortedMap<String, Command> COMMANDS = new ImmutableSortedMap.Builder<String, Command>(Ordering.natural())
        ...
        .put("fastq-to-bam", new Command("fastq-to-bam", "convert sequences in FASTQ format to unaligned BAM format", FastqToBam.class))
        .put("fastq-to-fasta", new Command("fastq-to-fasta", "convert sequences in FASTQ format to FASTA format", FastqToFasta.class))
        .put("fastq-to-text", new Command("fastq-to-text", "convert sequences in FASTQ format to tab-separated values (tsv) text format", FastqToText.class))
        ...
        .put("gfa1-to-cytoscape", new Command("gfa1-to-cytoscape", "convert GFA 1.0 format to nodes.txt and edges.txt format for Cytoscape", Gfa1ToCytoscape.class))
        .put("gfa1-to-cytoscape-edges", new Command("gfa1-to-cytoscape-edges", "convert GFA 1.0 format to edges.txt format for Cytoscape", Gfa1ToCytoscapeEdges.class))
        .put("gfa1-to-cytoscape-nodes", new Command("gfa1-to-cytoscape-nodes", "convert GFA 1.0 format to nodes.txt format for Cytoscape", Gfa1ToCytoscapeNodes.class))
        ...
        .put("interleaved-fastq-to-bam", new Command("interleaved-fastq-to-bam", "convert sequences in interleaved FASTQ format to unaligned BAM format", InterleavedFastqToBam.class))
