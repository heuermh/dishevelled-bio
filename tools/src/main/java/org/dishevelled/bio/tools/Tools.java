...
public final class Tools implements Callable<Integer> {
    ...
    static SortedMap<String, Command> COMMANDS = new ImmutableSortedMap.Builder<String, Command>(Ordering.natural())
        ...
        .put("fasta-to-parquet2", new Command("fasta-to-parquet2", "convert DNA or protein sequences in FASTA format to Parquet format, with transaction size", FastaToParquet2.class))
        .put("fasta-to-parquet3", new Command("fasta-to-parquet3", "convert DNA or protein sequences in FASTA format to Parquet format, with partition size", FastaToParquet3.class))
        .put("fasta-to-parquet4", new Command("fasta-to-parquet4", "convert DNA or protein sequences in FASTA format to Parquet format, with flush after", FastaToParquet4.class))
