...
public abstract class AbstractRangeTreeTest {
    ...
    /**
     * Create and return a new instance of an implementation of RangeTree with String values to test.
     *
     * @param ranges variable number of ranges
     * @return a new instance of an implementation of RangeTree with String values to test
     */
    protected abstract <C extends Comparable> RangeTree<C, String> create(Range<C>... ranges);
     ...
     * @return a new instance of an implementation of RangeTree with String values to test
     */
    protected abstract <C extends Comparable> RangeTree<C, String> create(List<Range<C>> ranges);
    ...
    private void countMany(final RangeTree<Integer, String> tree) {
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
