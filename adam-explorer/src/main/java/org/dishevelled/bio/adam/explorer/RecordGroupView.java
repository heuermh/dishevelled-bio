...
final class RecordGroupView extends LabelFieldPanel {
    ...
    RecordGroupView(final EventList<RecordGroup> recordGroups) {
        ...
        setOpaque(false);
        addFinalField(new RecordGroupTable(recordGroups));
    }

    /**
     * Record group table.
     */
    static class RecordGroupTable extends ElementsTable<RecordGroup> {
        private static final String[] PROPERTY_NAMES = { "name", "sample", "sequencingCenter", "description", "runDateEpoch", "flowOrder", "keySequence", "library", "predictedMedianInsertSize", "platform", "platformUnit" };
