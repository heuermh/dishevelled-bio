...
final class ContigView extends LabelFieldPanel {
    ...
    ContigView(final EventList<Contig> sequences) {
        ...
        setOpaque(false);
        addFinalField(new ContigTable(sequences));
    }

    /**
     * Contig table.
     */
    static class ContigTable extends ElementsTable<Contig> {
        private static final String[] PROPERTY_NAMES = { "referenceIndex", "contigName", "contigLength", "assembly", "species", "contigMD5", "referenceURL" };
