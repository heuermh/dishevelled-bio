...
public class ContainmentTest {
    ...
    public void testCtrNullContainer() {
        new Containment(null, contained, position, overlap, tags);
    }

    @Test(expected=NullPointerException.class)
    public void testCtrNullContained() {
        new Containment(container, null, position, overlap, tags);
    }
    ...
    public void testCtrInvalidPosition() {
        new Containment(container, contained, -1, overlap, tags);
    }

    @Test
    public void testCtr() {
        Containment containment = new Containment(container, contained, position, overlap, tags);
        ...
        assertEquals(tags, containment.getTags());
