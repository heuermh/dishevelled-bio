...
import static org.dishevelled.bio.assembly.gfa1.Gfa1Writer.write;
...
/**
 * Unit test for Gfa1Writer.
 *
 * @author  Michael Heuer
 */
public class Gfa1WriterTest {
    private Gfa1Record record;
    private Iterable<Gfa1Record> records;
    private StringWriter stringWriter;
    private PrintWriter writer;

    @Before
    public void setUp() throws Exception {
        records = read(new StringReader("H\tVN:Z:1.0\nS\t1\t*\tRC:i:2200067"));
    ...
    public void testWrite() throws Exception {
        write(record, writer);
        assertEquals("H\tVN:Z:1.0", stringWriter.toString().trim());
    }

    @Test(expected=NullPointerException.class)
    public void testWriteIterableNullRecords() throws Exception {
        write((Iterable<Gfa1Record>) null, writer);
    }
    ...
    public void testWriteIterable() throws Exception {
        ...
        assertEquals("H\tVN:Z:1.0\nS\t1\t*\tRC:i:2200067", stringWriter.toString().trim());
    }
}
